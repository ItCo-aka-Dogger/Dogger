package ru.itis.dogger.security;
...
import ru.itis.dogger.security.filters.JwtAuthenticationFilter;
import ru.itis.dogger.security.providers.JwtAuthenticationProvider;
import ru.itis.dogger.security.util.JwtTokenUtil;

@Configuration
@EnableGlobalMethodSecurity(prePostEnabled = true)
@EnableWebSecurity
@ComponentScan("ru.itis.dogger")
