...
Редактирование почты и пароля пользователя выполняется отдельно. Для этого нужно отправить в параметрах запроса "email" или другим запросом "password".
