...
В ответ придет информация о новой добавленной прогулке.
...
В ответ придет 400 ошибка, если такого места нет или если запрос был составлен некорректно, и информация о комментарии, если все прошло успешно.